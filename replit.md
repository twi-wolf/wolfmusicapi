...
## Key Files
- `shared/schema.ts` - All 590 endpoint definitions, 23 categories, and TypeScript types
...
## Recent Changes
- 2026-03-01: Added WormGPT and Replit AI to AI Chat (now 35 models), Bing Image Creator to AI Image (now 7 endpoints), Converter category with 6 media conversion endpoints (image↔sticker, video↔sticker, video↔GIF) for WhatsApp bots. Total now 590 endpoints across 23 categories.
