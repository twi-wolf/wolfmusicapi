...
export const apiCategories = [
  ...
  { id: "movie", name: "Movie", description: "Search movies & TV shows, get trailers, browse trending titles and ranked categories", icon: "Film" },
...
const movieEndpoints: ApiEndpoint[] = [
  { path: "/api/movie/search", method: "GET", description: "Search movies by title — returns posters, ratings, overview and release year", params: [{ name: "q", type: "string", required: true, description: "Movie title to search", default: "Avengers Endgame" }, { name: "page", type: "string", required: false, description: "Page number (default: 1)", default: "1" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/trailer", method: "GET", description: "Get YouTube trailers, teasers, clips and behind-the-scenes videos for a movie", params: [{ name: "id", type: "string", required: true, description: "TMDB movie ID (from search results)", default: "299534" }], format: "json", category: "movie", provider: "TMDB" },
