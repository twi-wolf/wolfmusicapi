...
const musicEndpoints: ApiEndpoint[] = [
  ...
  { path: "/download/ytmp5", method: "GET", description: "Get both MP3 and MP4 download URLs in one response", params: [{ name: "url", type: "string", required: false, description: "YouTube video URL" }, { name: "q", type: "string", required: false, description: "Song name to search" }], format: "json", category: "music" },
...
const socialMediaEndpoints: ApiEndpoint[] = [
  ...
  { path: "/api/download/facebook", method: "GET", description: "Download Facebook videos in SD and HD quality", params: [{ name: "url", type: "string", required: true, description: "Facebook video URL", default: "https://www.facebook.com/reel/1234567890" }], format: "json", category: "social-media", provider: "fdownloader.net" },
  { path: "/api/download/facebook/reel", method: "GET", description: "Download Facebook Reels (alias for general endpoint)", params: [{ name: "url", type: "string", required: true, description: "Facebook Reel URL", default: "https://www.facebook.com/reel/1234567890" }], format: "json", category: "social-media", provider: "fdownloader.net" },
  { path: "/api/download/facebook/snap", method: "GET", description: "Download Facebook video via snapsave.app — returns multi-quality links array", params: [{ name: "url", type: "string", required: true, description: "Facebook video or Reel URL", default: "https://www.facebook.com/reel/1234567890" }], format: "json", category: "social-media", provider: "snapsave.app" },
  { path: "/api/download/facebook/info", method: "GET", description: "Get Facebook video metadata (title, thumbnail, quality info) without direct download links", params: [{ name: "url", type: "string", required: true, description: "Facebook video or Reel URL", default: "https://www.facebook.com/reel/1234567890" }], format: "json", category: "social-media", provider: "fdownloader.net" },
