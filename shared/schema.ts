...
const movieEndpoints: ApiEndpoint[] = [
  { path: "/api/movie/search", method: "GET", description: "Search movies by title", params: [{ name: "q", type: "string", required: true, description: "Movie title to search" }, { name: "page", type: "string", required: false, description: "Page number (default: 1)" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/info", method: "GET", description: "Get detailed movie information by TMDB ID", params: [{ name: "id", type: "string", required: true, description: "TMDB movie ID" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/trailer", method: "GET", description: "Get movie trailer and videos", params: [{ name: "id", type: "string", required: true, description: "TMDB movie ID" }], format: "json", category: "movie", provider: "TMDB" },
  ...
  { path: "/api/movie/popular", method: "GET", description: "Get popular movies", params: [{ name: "page", type: "string", required: false, description: "Page number" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/upcoming", method: "GET", description: "Get upcoming movies in theaters", params: [{ name: "page", type: "string", required: false, description: "Page number" }], format: "json", category: "movie", provider: "TMDB" },
  ...
  { path: "/api/movie/now-playing", method: "GET", description: "Get movies currently in theaters", params: [{ name: "page", type: "string", required: false, description: "Page number" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/similar", method: "GET", description: "Get movies similar to a given movie", params: [{ name: "id", type: "string", required: true, description: "TMDB movie ID" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/credits", method: "GET", description: "Get movie cast and crew", params: [{ name: "id", type: "string", required: true, description: "TMDB movie ID" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/reviews", method: "GET", description: "Get movie reviews from users", params: [{ name: "id", type: "string", required: true, description: "TMDB movie ID" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/genres", method: "GET", description: "List all movie genres", params: [], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/discover", method: "GET", description: "Discover movies by genre, year, or sort", params: [{ name: "genre", type: "string", required: false, description: "Genre ID" }, { name: "year", type: "string", required: false, description: "Release year" }, { name: "sort", type: "string", required: false, description: "Sort by (default: popularity.desc)" }], format: "json", category: "movie", provider: "TMDB" },
];
