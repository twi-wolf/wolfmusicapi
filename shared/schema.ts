...
const aiToolEndpoints: ApiEndpoint[] = [
  ...
  { path: "/api/ai/removebg", method: "POST", description: "Remove image background instantly — returns transparent PNG as base64 and hosted URL via catbox", params: [{ name: "image_url", type: "string", required: false, description: "URL of image to process (use this or image)", default: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Cat03.jpg/320px-Cat03.jpg" }, { name: "image", type: "string", required: false, description: "Base64-encoded image data (use this or image_url)" }], format: "json", category: "ai-tools", provider: "remove.bg" },
  { path: "/api/ai/tools/generate", method: "GET", description: "Generate any image from a text prompt — returns a direct image URL powered by Pollinations AI", params: [{ name: "prompt", type: "string", required: true, description: "Image description prompt", default: "a cyberpunk wolf hacker at a glowing terminal" }, { name: "ratio", type: "string", required: false, description: "Aspect ratio: 1:1 | 16:9 | 9:16 | 4:3 | 3:4 (default 1:1)", default: "1:1" }, { name: "model", type: "string", required: false, description: "Model: flux | flux-realism | flux-anime | flux-3d | any-dark | turbo (default flux)", default: "flux" }], format: "json", category: "ai-tools", provider: "Pollinations" },
  { path: "/api/ai/tools/ghibli", method: "GET", description: "Transform any scene description into Studio Ghibli-style artwork", params: [{ name: "prompt", type: "string", required: true, description: "Scene or subject to render in Ghibli style", default: "a forest village with fireflies at twilight" }, { name: "ratio", type: "string", required: false, description: "Aspect ratio: 1:1 | 16:9 | 9:16 | 4:3 | 3:4 (default 16:9)", default: "16:9" }], format: "json", category: "ai-tools", provider: "Pollinations" },
  { path: "/api/ai/tools/anime", method: "GET", description: "Generate anime-style artwork from a text prompt", params: [{ name: "prompt", type: "string", required: true, description: "Character or scene description", default: "a silver-haired warrior under cherry blossoms" }, { name: "ratio", type: "string", required: false, description: "Aspect ratio: 1:1 | 16:9 | 9:16 | 4:3 | 3:4 (default 9:16)", default: "9:16" }], format: "json", category: "ai-tools", provider: "Pollinations" },
  { path: "/api/ai/tools/realistic", method: "GET", description: "Generate photorealistic images from a text description", params: [{ name: "prompt", type: "string", required: true, description: "Scene or subject description", default: "a wolf sitting on a mountain cliff at sunset, golden hour, 8K" }, { name: "ratio", type: "string", required: false, description: "Aspect ratio: 1:1 | 16:9 | 9:16 | 4:3 | 3:4 (default 16:9)", default: "16:9" }], format: "json", category: "ai-tools", provider: "Pollinations" },
  { path: "/api/ai/tools/portrait", method: "GET", description: "Generate a professional AI portrait or avatar from a description", params: [{ name: "prompt", type: "string", required: true, description: "Describe the person, style, or character", default: "a young hacker with green glowing eyes and hoodie, cyberpunk portrait" }, { name: "ratio", type: "string", required: false, description: "Aspect ratio: 1:1 | 9:16 (default 1:1)", default: "1:1" }], format: "json", category: "ai-tools", provider: "Pollinations" },
  { path: "/api/ai/tools/dark-art", method: "GET", description: "Generate dark fantasy or gothic artwork from a text prompt", params: [{ name: "prompt", type: "string", required: true, description: "Dark scene, creature, or concept to render", default: "a cloaked figure in a ruined cathedral under a blood moon" }, { name: "ratio", type: "string", required: false, description: "Aspect ratio: 1:1 | 16:9 | 9:16 (default 9:16)", default: "9:16" }], format: "json", category: "ai-tools", provider: "Pollinations" },
  { path: "/api/ai/tools/style-transfer", method: "GET", description: "Apply a specific art style to any subject description — ghibli, anime, oil-painting, watercolor, cartoon, cyberpunk, vintage, sketch, 3d-render", params: [{ name: "prompt", type: "string", required: true, description: "Subject or scene description", default: "a wolf in a forest" }, { name: "style", type: "string", required: true, description: "Target style: ghibli | anime | oil-painting | watercolor | cartoon | cyberpunk | vintage | sketch | 3d-render", default: "oil-painting" }, { name: "ratio", type: "string", required: false, description: "Aspect ratio: 1:1 | 16:9 | 9:16 | 4:3 | 3:4 (default 1:1)", default: "1:1" }], format: "json", category: "ai-tools", provider: "Pollinations" },
  { path: "/api/ai/tools/prompt-enhance", method: "GET", description: "Enhance and expand a basic image idea into a detailed, optimized prompt for AI image generation", params: [{ name: "prompt", type: "string", required: true, description: "Basic image idea to enhance", default: "a wolf in a city" }], format: "json", category: "ai-tools", provider: "ChatEverywhere" },
  { path: "/api/ai/tools/image-edit", method: "GET", description: "Edit or transform an existing image — provide a URL and/or a description, then specify what to change. Generates a new AI-edited version via Pollinations.", params: [{ name: "image_url", type: "string", required: false, description: "Direct URL of the image you want to edit (e.g. https://example.com/photo.jpg). Use this or 'description' — or both together.", default: "https://image.pollinations.ai/prompt/wolf?width=512&height=512&model=flux" }, { name: "description", type: "string", required: false, description: "Text description of your image. Required if 'image_url' is not provided; optional when a URL is given.", default: "a wolf standing in a snowy forest at night" }, { name: "edit_prompt", type: "string", required: true, description: "What you want to change or add (e.g. 'make it daytime', 'add cherry blossoms', 'change to cyberpunk city')", default: "add cherry blossoms and make it ghibli style" }, { name: "style", type: "string", required: false, description: "Optional output style: realistic | anime | ghibli | oil-painting | cartoon | dark", default: "ghibli" }, { name: "ratio", type: "string", required: false, description: "Aspect ratio: 1:1 | 16:9 | 9:16 | 4:3 | 3:4 (default 1:1)", default: "1:1" }], format: "json", category: "ai-tools", provider: "Pollinations + ChatEverywhere" },
];
...
const aiImageEndpoints: ApiEndpoint[] = [
  ...
  { path: "/api/ai/image/dog", method: "GET", description: "Get random dog image", params: [{ name: "breed", type: "string", required: false, description: "Dog breed (e.g. husky, poodle)", default: "husky" }], format: "json", category: "ai-image", provider: "Dog CEO" },
  { path: "/api/ai/image/cat", method: "GET", description: "Get random cat image", params: [], format: "json", category: "ai-image", provider: "CATAAS" },
  { path: "/api/ai/image/bing", method: "POST", description: "Generate AI image via Bing Image Creator", params: [{ name: "prompt", type: "string", required: true, description: "Image generation prompt", default: "a wolf howling at the moon in cyberpunk style" }], format: "json", category: "ai-image", provider: "Bing" },
];
...
const socialMediaEndpoints: ApiEndpoint[] = [
  { path: "/api/download/youtube", method: "GET", description: "Download YouTube videos in multiple qualities", params: [{ name: "url", type: "string", required: false, description: "YouTube video URL", default: "https://www.youtube.com/watch?v=e-ORhEE9VVg" }, { name: "q", type: "string", required: false, description: "Video name to search", default: "Home NF" }], format: "json", category: "social-media", provider: "y2mate.nu" },
  { path: "/api/download/youtube/mp3", method: "GET", description: "Download YouTube video as MP3 audio", params: [{ name: "url", type: "string", required: false, description: "YouTube video URL", default: "https://www.youtube.com/watch?v=e-ORhEE9VVg" }, { name: "q", type: "string", required: false, description: "Song name to search", default: "Home NF" }], format: "json", category: "social-media", provider: "y2mate.nu" },
  { path: "/api/download/youtube/mp4", method: "GET", description: "Download YouTube video as MP4", params: [{ name: "url", type: "string", required: false, description: "YouTube video URL", default: "https://www.youtube.com/watch?v=e-ORhEE9VVg" }, { name: "q", type: "string", required: false, description: "Video name to search", default: "Home NF" }], format: "json", category: "social-media", provider: "y2mate.nu" },
  { path: "/api/download/youtube/info", method: "GET", description: "Get YouTube video info without downloading", params: [{ name: "url", type: "string", required: true, description: "YouTube video URL", default: "https://www.youtube.com/watch?v=e-ORhEE9VVg" }], format: "json", category: "social-media", provider: "y2mate.nu" },
  { path: "/api/download/youtube/search", method: "GET", description: "Search YouTube videos", params: [{ name: "q", type: "string", required: true, description: "Search query", default: "Home NF" }], format: "json", category: "social-media", provider: "WolfAPIs" },
...
const urlShortenerEndpoints: ApiEndpoint[] = [
  { path: "/api/short/tinyurl", method: "GET", description: "Shorten URL with TinyURL", params: [{ name: "url", type: "string", required: true, description: "The URL to shorten", default: "https://apis.xwolf.space" }], format: "json", category: "urlshortener", provider: "TinyURL" },
  { path: "/api/short/isgd", method: "GET", description: "Shorten URL with is.gd", params: [{ name: "url", type: "string", required: true, description: "The URL to shorten", default: "https://apis.xwolf.space" }], format: "json", category: "urlshortener", provider: "is.gd" },
  { path: "/api/short/vgd", method: "GET", description: "Shorten URL with v.gd", params: [{ name: "url", type: "string", required: true, description: "The URL to shorten", default: "https://apis.xwolf.space" }], format: "json", category: "urlshortener", provider: "v.gd" },
  { path: "/api/short/cleanuri", method: "GET", description: "Shorten URL with CleanURI", params: [{ name: "url", type: "string", required: true, description: "The URL to shorten", default: "https://apis.xwolf.space" }], format: "json", category: "urlshortener", provider: "CleanURI" },
  { path: "/api/short/chilpit", method: "GET", description: "Shorten URL with Chilp.it", params: [{ name: "url", type: "string", required: true, description: "The URL to shorten", default: "https://apis.xwolf.space" }], format: "json", category: "urlshortener", provider: "Chilp.it" },
  { path: "/api/short/clckru", method: "GET", description: "Shorten URL with clck.ru", params: [{ name: "url", type: "string", required: true, description: "The URL to shorten", default: "https://apis.xwolf.space" }], format: "json", category: "urlshortener", provider: "clck.ru" },
  { path: "/api/short/dagd", method: "GET", description: "Shorten URL with da.gd", params: [{ name: "url", type: "string", required: true, description: "The URL to shorten", default: "https://apis.xwolf.space" }], format: "json", category: "urlshortener", provider: "da.gd" },
...
const toolsEndpoints: ApiEndpoint[] = [
  ...
  { path: "/api/tools/base64encode", method: "GET", description: "Encode text to Base64", params: [{ name: "text", type: "string", required: true, description: "Text to encode", default: "Hello World" }], format: "json", category: "tools", provider: "Built-in" },
  { path: "/api/tools/base64decode", method: "GET", description: "Decode Base64 to text", params: [{ name: "text", type: "string", required: true, description: "Base64 string to decode", default: "SGVsbG8gV29ybGQ=" }], format: "json", category: "tools", provider: "Built-in" },
  { path: "/api/tools/textstats", method: "GET", description: "Analyze text statistics", params: [{ name: "text", type: "string", required: true, description: "Text to analyze", default: "Hello World, this is a sample text for analysis." }], format: "json", category: "tools", provider: "Built-in" },
  { path: "/api/tools/password", method: "GET", description: "Generate secure random password", params: [{ name: "length", type: "number", required: false, description: "Password length (default 16)", default: "16" }], format: "json", category: "tools", provider: "Built-in" },
  { path: "/api/tools/lorem", method: "GET", description: "Generate Lorem Ipsum text", params: [{ name: "paragraphs", type: "number", required: false, description: "Number of paragraphs (default 1)", default: "2" }], format: "json", category: "tools", provider: "Built-in" },
  ...
  { path: "/api/tools/urlencode", method: "GET", description: "URL encode a string", params: [{ name: "text", type: "string", required: true, description: "Text to encode", default: "Hello World & More" }], format: "json", category: "tools", provider: "Built-in" },
  { path: "/api/tools/urldecode", method: "GET", description: "URL decode a string", params: [{ name: "text", type: "string", required: true, description: "Text to decode", default: "Hello+World+%26+More" }], format: "json", category: "tools", provider: "Built-in" },
  { path: "/api/tools/jsonformat", method: "POST", description: "Format/validate JSON", params: [{ name: "json", type: "string", required: true, description: "JSON string to format", default: "{\"name\":\"Wolf\",\"api\":\"Silent Wolf\"}" }], format: "json", category: "tools", provider: "Built-in" },
  { path: "/api/tools/email-validate", method: "GET", description: "Validate email format", params: [{ name: "email", type: "string", required: true, description: "Email to validate", default: "test@example.com" }], format: "json", category: "tools", provider: "Built-in" },
  { path: "/api/tools/ip-validate", method: "GET", description: "Validate IP address", params: [{ name: "ip", type: "string", required: true, description: "IP address to validate", default: "192.168.1.1" }], format: "json", category: "tools", provider: "Built-in" },
  { path: "/api/tools/hash", method: "GET", description: "Generate hash from text", params: [{ name: "text", type: "string", required: true, description: "Text to hash", default: "Hello World" }, { name: "algorithm", type: "string", required: false, description: "Hash algorithm (md5, sha1, sha256, sha512)", default: "sha256" }], format: "json", category: "tools", provider: "Built-in" },
...
const securityEndpoints: ApiEndpoint[] = [
  { path: "/api/security/whois", method: "GET", description: "WHOIS domain lookup", params: [{ name: "domain", type: "string", required: true, description: "Domain to lookup", default: "apis.xwolf.space" }], format: "json", category: "security", provider: "RDAP" },
  { path: "/api/security/dns", method: "GET", description: "DNS records lookup (A, AAAA, MX, TXT, NS, CNAME)", params: [{ name: "domain", type: "string", required: true, description: "Domain to lookup", default: "apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/subdomain", method: "GET", description: "Scan for common subdomains", params: [{ name: "domain", type: "string", required: true, description: "Domain to scan", default: "apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/reverse-ip", method: "GET", description: "Reverse IP lookup", params: [{ name: "ip", type: "string", required: true, description: "IP address", default: "8.8.8.8" }], format: "json", category: "security", provider: "Built-in" },
  ...
  { path: "/api/security/portscan", method: "GET", description: "Scan common ports on a host", params: [{ name: "host", type: "string", required: true, description: "Hostname or IP", default: "apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/headers", method: "GET", description: "Fetch HTTP response headers", params: [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/ssl", method: "GET", description: "Check SSL certificate details", params: [{ name: "host", type: "string", required: true, description: "Hostname to check", default: "apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/tls", method: "GET", description: "Get TLS connection details", params: [{ name: "host", type: "string", required: true, description: "Hostname to check", default: "apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/ping", method: "GET", description: "Ping a host and check latency", params: [{ name: "host", type: "string", required: true, description: "Hostname to ping", default: "apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/latency", method: "GET", description: "Measure HTTP latency", params: [{ name: "url", type: "string", required: true, description: "URL to test", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/traceroute", method: "GET", description: "Trace route to host", params: [{ name: "host", type: "string", required: true, description: "Hostname to trace", default: "apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  ...
  { path: "/api/security/security-headers", method: "GET", description: "Analyze security headers with scoring", params: [{ name: "url", type: "string", required: true, description: "URL to analyze", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/waf", method: "GET", description: "Detect Web Application Firewall", params: [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/firewall", method: "GET", description: "Check firewall and security headers", params: [{ name: "host", type: "string", required: true, description: "Hostname to check", default: "apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/robots", method: "GET", description: "Check robots.txt file", params: [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/sitemap", method: "GET", description: "Check sitemap.xml", params: [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/cms", method: "GET", description: "Detect CMS/platform", params: [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/techstack", method: "GET", description: "Detect technology stack", params: [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/cookies", method: "GET", description: "Scan cookies for security flags", params: [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/redirects", method: "GET", description: "Check redirect chain", params: [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/xss", method: "GET", description: "Check XSS protection headers", params: [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/sqli", method: "GET", description: "Check SQL injection protection", params: [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/csrf", method: "GET", description: "Check CSRF protection", params: [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/clickjack", method: "GET", description: "Check clickjacking protection", params: [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/directory", method: "GET", description: "Scan for exposed directories", params: [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/exposed-files", method: "GET", description: "Check for exposed sensitive files", params: [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/misconfig", method: "GET", description: "Check security misconfigurations", params: [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/hash-identify", method: "GET", description: "Identify hash type", params: [{ name: "hash", type: "string", required: true, description: "Hash string to identify", default: "5d41402abc4b2a76b9719d911017c592" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/hash-generate", method: "GET", description: "Generate hash from text", params: [{ name: "text", type: "string", required: true, description: "Text to hash", default: "Hello World" }, { name: "algorithm", type: "string", required: false, description: "Algorithm (md5, sha1, sha256, sha512)", default: "sha256" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/password-strength", method: "GET", description: "Check password strength", params: [{ name: "password", type: "string", required: true, description: "Password to check", default: "MyP@ssw0rd123!" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/openports", method: "GET", description: "Scan extended port range", params: [{ name: "host", type: "string", required: true, description: "Hostname or IP", default: "apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  ...
  { path: "/api/security/url-scan", method: "GET", description: "Full URL security scan", params: [{ name: "url", type: "string", required: true, description: "URL to scan", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/phish", method: "GET", description: "Check URL for phishing indicators", params: [{ name: "url", type: "string", required: true, description: "URL to check", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
  { path: "/api/security/metadata", method: "GET", description: "Extract website metadata", params: [{ name: "url", type: "string", required: true, description: "Website URL", default: "https://apis.xwolf.space" }], format: "json", category: "security", provider: "Built-in" },
];
...
const searchEndpoints: ApiEndpoint[] = [
  ...
  { path: "/api/search/github", method: "GET", description: "Search GitHub repositories", params: [{ name: "q", type: "string", required: true, description: "Search query", default: "wolfmusicapi" }], format: "json", category: "search", provider: "GitHub" },
  ...
  { path: "/api/search/videos", method: "GET", description: "Search and return videos with thumbnails, duration and source for any keyword", params: [{ name: "q", type: "string", required: true, description: "Video search query (e.g. superman trailer, nature documentary)", default: "superman trailer" }, { name: "page", type: "string", required: false, description: "Page number (0-based, default: 0)", default: "0" }], format: "json", category: "search", provider: "Yandex Videos" },
];

const movieEndpoints: ApiEndpoint[] = [
  { path: "/api/movie/search", method: "GET", description: "Search movies by title via TMDB", params: [{ name: "q", type: "string", required: true, description: "Movie title to search", default: "Avengers Endgame" }, { name: "page", type: "string", required: false, description: "Page number (default: 1)", default: "1" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/info", method: "GET", description: "Get full movie details: plot, genres, runtime, budget, revenue, poster, backdrop", params: [{ name: "id", type: "string", required: true, description: "TMDB movie ID", default: "299534" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/trailer", method: "GET", description: "Get YouTube trailers, teasers, clips and behind-the-scenes videos for a movie", params: [{ name: "id", type: "string", required: true, description: "TMDB movie ID", default: "299534" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/trending", method: "GET", description: "Get trending movies today or this week", params: [{ name: "time", type: "string", required: false, description: "Time window: day or week (default: day)", default: "day" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/trending-all", method: "GET", description: "Get trending movies, TV shows and people today or this week", params: [{ name: "time", type: "string", required: false, description: "Time window: day or week (default: day)", default: "day" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/popular", method: "GET", description: "Get popular movies with ratings, posters and overview", params: [{ name: "page", type: "string", required: false, description: "Page number", default: "1" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/upcoming", method: "GET", description: "Get upcoming movies in theaters with release dates", params: [{ name: "page", type: "string", required: false, description: "Page number", default: "1" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/top-rated", method: "GET", description: "Get top rated movies of all time", params: [{ name: "page", type: "string", required: false, description: "Page number", default: "1" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/now-playing", method: "GET", description: "Get movies currently playing in theaters", params: [{ name: "page", type: "string", required: false, description: "Page number", default: "1" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/similar", method: "GET", description: "Get similar movies and recommendations for a given movie", params: [{ name: "id", type: "string", required: true, description: "TMDB movie ID", default: "299534" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/credits", method: "GET", description: "Get full cast and crew for a movie", params: [{ name: "id", type: "string", required: true, description: "TMDB movie ID", default: "299534" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/reviews", method: "GET", description: "Get user reviews with ratings and author details", params: [{ name: "id", type: "string", required: true, description: "TMDB movie ID", default: "299534" }], format: "json", category: "movie", provider: "TMDB" },
  ...
  { path: "/api/movie/discover", method: "GET", description: "Discover movies by genre ID, year, and sort order", params: [{ name: "genre", type: "string", required: false, description: "TMDB genre ID (e.g. 28 for Action)", default: "28" }, { name: "year", type: "string", required: false, description: "Primary release year", default: "2024" }, { name: "sort", type: "string", required: false, description: "Sort by (default: popularity.desc)", default: "popularity.desc" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/images", method: "GET", description: "Get backdrops, posters and logos for a movie", params: [{ name: "id", type: "string", required: true, description: "TMDB movie ID", default: "299534" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/movie/person", method: "GET", description: "Get actor/director biography, birthday, photos and known movies", params: [{ name: "id", type: "string", required: true, description: "TMDB person ID", default: "1136406" }], format: "json", category: "movie", provider: "TMDB" },
  { path: "/api/xcasper/search", method: "GET", description: "Search movies & TV shows by title (type: movie or tv)", params: [{ name: "q", type: "string", required: true, description: "Movie or show title", default: "Avatar" }, { name: "type", type: "string", required: false, description: "Filter: movie or tv (default: all)", default: "movie" }, { name: "page", type: "string", required: false, description: "Page number (default: 1)", default: "1" }, { name: "perPage", type: "string", required: false, description: "Results per page (default: 10)", default: "10" }], format: "json", category: "movie", provider: "XCasper" },
  ...
  { path: "/api/xcasper/trending", method: "GET", description: "Get currently trending movies and TV shows", params: [{ name: "page", type: "string", required: false, description: "Page (default: 0)", default: "0" }, { name: "perPage", type: "string", required: false, description: "Results per page (default: 18)", default: "18" }], format: "json", category: "movie", provider: "XCasper" },
  { path: "/api/xcasper/browse", method: "GET", description: "Browse movies or TV shows filtered by genre and country", params: [{ name: "type", type: "string", required: false, description: "movie or tv (default: movie)", default: "movie" }, { name: "genre", type: "string", required: false, description: "Genre name e.g. Action, Drama, Comedy", default: "Action" }, { name: "country", type: "string", required: false, description: "Country name e.g. United States, South Korea", default: "United States" }, { name: "page", type: "string", required: false, description: "Page (default: 1)", default: "1" }], format: "json", category: "movie", provider: "XCasper" },
  ...
  { path: "/api/xcasper/newtoxic/latest", method: "GET", description: "Get the latest newly added movies and shows from Newtoxic", params: [{ name: "page", type: "string", required: false, description: "Page number (default: 1)", default: "1" }], format: "json", category: "movie", provider: "XCasper/Newtoxic" },
  ...
  { path: "/api/xcasper/newtoxic/detail", method: "GET", description: "Get movie or show details from Newtoxic by path slug", params: [{ name: "path", type: "string", required: true, description: "Newtoxic path slug e.g. new/1/Downloads/movie/Avatar-2009.html", default: "new/1/Downloads/movie/Avatar-2009.html" }], format: "json", category: "movie", provider: "XCasper/Newtoxic" },
  ...
  { path: "/api/xcasper/staff/works", method: "GET", description: "Get all movies and shows an actor or director has appeared in", params: [{ name: "id", type: "string", required: true, description: "staffId", default: "2481188729860280112" }, { name: "page", type: "string", required: false, description: "Page (default: 1)", default: "1" }], format: "json", category: "movie", provider: "XCasper" },
  ...
  { path: "/api/xcasper/trailer", method: "GET", description: "Get a direct MP4 trailer URL for any movie or TV show by its subjectId", params: [{ name: "id", type: "string", required: true, description: "subjectId from /api/xcasper/search results", default: "1234376946650333432" }], format: "json", category: "movie", provider: "XCasper" },
  { path: "/api/xcasper/ranking-content", method: "GET", description: "Get the ranked list of movies/shows in a specific category (e.g. Popular, Action, Nollywood)", params: [{ name: "id", type: "string", required: true, description: "Ranking category ID from /api/xcasper/ranking", default: "997144265920760504" }, { name: "page", type: "string", required: false, description: "Page number (default: 1)", default: "1" }, { name: "perPage", type: "string", required: false, description: "Results per page (default: 12)", default: "12" }], format: "json", category: "movie", provider: "XCasper" },
  { path: "/api/xcasper/ratings", method: "GET", description: "Get IMDb, Rotten Tomatoes and Metacritic ratings for any movie or TV show", params: [{ name: "q", type: "string", required: false, description: "Movie or show title (use this or imdbid)", default: "Avengers Endgame" }, { name: "imdbid", type: "string", required: false, description: "IMDb ID (e.g. tt4154796) — use this or q", default: "tt4154796" }], format: "json", category: "movie", provider: "OMDB" },
  { path: "/api/xcasper/omdb-search", method: "GET", description: "Search movies, series or episodes by keyword via OMDB/IMDb data", params: [{ name: "q", type: "string", required: true, description: "Movie or show title keyword", default: "avengers" }, { name: "type", type: "string", required: false, description: "Filter: movie | series | episode (default: movie)", default: "movie" }, { name: "page", type: "string", required: false, description: "Page number (default: 1)", default: "1" }], format: "json", category: "movie", provider: "OMDB" },
];
...
const textproEndpoints: ApiEndpoint[] = [
  ...
  { path: "/api/textpro/generate", method: "GET", description: "Generate a styled text effect image", params: [{ name: "effect", type: "string", required: true, description: "Effect ID from the effects list", default: "alien-glow" }, { name: "text", type: "string", required: true, description: "Text to render", default: "WolfAPI" }], format: "json", category: "textpro", provider: "CoolText" },
  ...TEXTPRO_EFFECTS.map(e => ({
    path: `/api/textpro/${e.id}`,
    method: "GET" as const,
    description: `Generate ${e.name} text effect`,
    params: [{ name: "text", type: "string", required: true, description: "Text to render", default: "WolfAPI" }],
...
const converterEndpoints: ApiEndpoint[] = [
  { path: "/api/converter/img-to-sticker", method: "GET", description: "Convert image to WhatsApp sticker (WebP)", params: [{ name: "url", type: "string", required: true, description: "Image URL to convert", default: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Cat03.jpg/320px-Cat03.jpg" }], format: "json", category: "converter", provider: "WolfAPIs" },
  { path: "/api/converter/sticker-to-img", method: "GET", description: "Convert sticker (WebP) to image (PNG)", params: [{ name: "url", type: "string", required: true, description: "Sticker/WebP URL to convert", default: "https://www.gstatic.com/webp/gallery/1.webp" }], format: "json", category: "converter", provider: "WolfAPIs" },
  { path: "/api/converter/video-to-sticker", method: "GET", description: "Convert video to animated WhatsApp sticker", params: [{ name: "url", type: "string", required: true, description: "Video URL (MP4, max 6 seconds)", default: "https://www.w3schools.com/html/mov_bbb.mp4" }], format: "json", category: "converter", provider: "WolfAPIs" },
  { path: "/api/converter/sticker-to-video", method: "GET", description: "Convert animated sticker to video (MP4)", params: [{ name: "url", type: "string", required: true, description: "Animated sticker/WebP URL", default: "https://www.gstatic.com/webp/gallery/1.webp" }], format: "json", category: "converter", provider: "WolfAPIs" },
  { path: "/api/converter/video-to-gif", method: "GET", description: "Convert video to GIF", params: [{ name: "url", type: "string", required: true, description: "Video URL to convert", default: "https://www.w3schools.com/html/mov_bbb.mp4" }], format: "json", category: "converter", provider: "WolfAPIs" },
  { path: "/api/converter/gif-to-video", method: "GET", description: "Convert GIF to video (MP4)", params: [{ name: "url", type: "string", required: true, description: "GIF URL to convert", default: "https://media.giphy.com/media/JIX9t2j0ZTN9S/giphy.gif" }], format: "json", category: "converter", provider: "WolfAPIs" },
];
