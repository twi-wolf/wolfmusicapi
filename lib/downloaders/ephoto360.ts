...
export const EPHOTO_EFFECTS: EphotoEffect[] = [
  ...
  { id: "writeonwetglass", name: "Write on Wet Glass", slug: "create-broken-glass-text-effect-online-698", category: "text-effects", params: [{ name: "text", type: "text", placeholder: "Wet glass text" }] },
